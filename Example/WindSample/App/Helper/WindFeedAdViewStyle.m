...
@implementation WindFeedAdViewStyle
...
+ (CGFloat)cellGroupImageHeightWithModel:(WindNativeAd *)nativeAd width:(CGFloat)width {
...
+ (CGFloat)cellNativeExpressHeightWithModel:(WindNativeAd *)model width:(CGFloat)width {
    return 0;
}

+ (void)renderAdWithLargeImg:(WindNativeAd *)nativeAd adView:(NativeAdCustomView *)adView{
...
+ (void)renderAdWithVideo:(WindNativeAd *)nativeAd adView:(NativeAdCustomView *)adView{
