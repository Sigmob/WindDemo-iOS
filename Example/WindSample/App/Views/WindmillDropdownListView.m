...
@interface WindmillDropdownListView()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UILabel *textLabel;
@property (nonatomic, strong) UIImageView *arrowImg;
@property (nonatomic, strong) UITableView *tbView;
@property (nonatomic, strong) UIView *tbBackView;
@property (nonatomic, strong) UIView *backgroundView;
@property (nonatomic, copy) WindmillDropdownListViewSelectedBlock selectedBlock;
@end
...
@implementation WindmillDropdownListView
...
-(void)tapViewExpand:(UITapGestureRecognizer *)sender {
    ...
    [window addSubview:self.tbBackView];
    [self.tbBackView addSubview:self.tbView];
    ...
    self.tbBackView.frame = tableViewFrame;
    _tbView.frame = self.tbBackView.bounds;
...
- (void)removeBackgroundView {
    [_tbBackView removeFromSuperview];
...
- (UIView *)tbBackView {
    if (!_tbBackView) {
        _tbBackView = [UIView new];
        _tbBackView.clipsToBounds = YES;
        _tbBackView.backgroundColor = UIColor.whiteColor;
    }
    return _tbBackView;;
}
